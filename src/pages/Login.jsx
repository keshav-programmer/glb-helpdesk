    ...
    >
      ...
      <div
        style={{
          ...
          padding: "60px 64px",
          // Hide on mobile — login card takes full screen
      ...
      >
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            The official maintenance helpdesk for GLBIT Greater Noida. Report
            hostel or classroom issues and track them in real time.
          </p>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 340 }}>
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "var(--info)" }}>@glbitm.ac.in</strong>{" "}
              students and staff. Personal Gmail accounts will be rejected.
            </p>
          </div>
